class VideoPlayer {
    ...
    loadVideo() {
        ...
        this.elements.panelDetailedDescription.textContent = this.options.videoList[this.options.activeTrack].detailedDescription;
        //roles
        ...
        this.elements.panelTask.textContent = this.options.videoList[this.options.activeTrack].task;
		this.elements.panelSolution.textContent = this.options.videoList[this.options.activeTrack].solution;
		this.elements.panelResult.textContent = this.options.videoList[this.options.activeTrack].result;
